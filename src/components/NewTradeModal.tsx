...
export function NewTradeModal({ onTradeAdded }: NewTradeModalProps) {
  ...
  const uploadImage = async (file: File): Promise<string | null> => {
    ...
    }I need to complete the NewTradeModal component. Let me finish it:

<dyad-write path="src/components/NewTradeModal.tsx" description="Completing NewTradeModal with refresh triggers">
import { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { useAuth } from '@/contexts/AuthContext';
import { supabase } from '@/integrations/supabase/client';
